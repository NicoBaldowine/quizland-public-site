...
export default function FeatureBox({ title, description, bgColor, videoSource }: FeatureBoxProps) {
  return (
    <div 
      className={`px-6 md:px-12 pt-8 md:pt-16 ${bgColor} rounded-[20px] md:rounded-[40px] w-full md:w-[505px] h-[500px] md:h-[650px] flex flex-col relative overflow-hidden group`}
    >
      <h2 className="font-outfit text-2xl md:text-[36px] font-semibold mb-4 text-[#101827] leading-tight">{title}</h2>
