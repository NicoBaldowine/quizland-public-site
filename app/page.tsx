...
export default function HomePage() {
  ...
  return (
    <div className="bg-[#101827] min-h-screen relative overflow-x-hidden">
      <div className="relative z-10">
        <HeroSection openModal={openModal} />
        <section className="py-8 md:py-16 px-4">
          <div className="max-w-[1090px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-y-10 gap-x-[40px] justify-items-center">
            <FadeInSection>
              <FeatureBox 
